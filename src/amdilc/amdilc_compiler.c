    ...
    const Instruction* instr)
{
    ...
    case IL_OP_ITOF: {
        IlcSpvId iSrcId = ilcSpvPutBitcast(compiler->module, compiler->int4Id, srcIds[0]);
        resId = ilcSpvPutAlu(compiler->module, SpvOpConvertSToF, compiler->float4Id, 1, &iSrcId);
    }   break;
