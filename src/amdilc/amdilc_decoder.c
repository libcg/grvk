...
static const OpcodeInfo mOpcodeInfos[IL_OP_LAST] = {
    ...
    [IL_OP_DCLARRAY] = { IL_OP_DCLARRAY, 0, 2, 0, false },
    ...
    [IL_DCL_NUM_ICP] = { IL_DCL_NUM_ICP, 0, 0, 1, false },
    [IL_DCL_NUM_OCP] = { IL_DCL_NUM_OCP, 0, 0, 1, false },
    [IL_OP_HS_FORK_PHASE] = { IL_OP_HS_FORK_PHASE, 0, 0, 0, false },
    [IL_DCL_TS_DOMAIN] = { IL_DCL_TS_DOMAIN, 0, 0, 0, false },
    [IL_DCL_TS_PARTITION] = { IL_DCL_TS_PARTITION, 0, 0, 0, false },
    [IL_DCL_TS_OUTPUT_PRIMITIVE] = { IL_DCL_TS_OUTPUT_PRIMITIVE, 0, 0, 0, false },
