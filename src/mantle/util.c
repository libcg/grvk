...
// valid nfmt contains 3 bits so it's safe to save up extra 13 bits to create an array
...
static const GrFormatInfo formats[PACK_FORMAT(GR_CH_FMT_BC7 + 1, GR_NUM_FMT_UNDEFINED)] = {
    [PACK_FORMAT(GR_CH_FMT_UNDEFINED, GR_NUM_FMT_UNDEFINED)] = { VK_FORMAT_UNDEFINED, 0 },
    [PACK_FORMAT(GR_CH_FMT_R4G4, GR_NUM_FMT_UNORM)] = { VK_FORMAT_UNDEFINED, 0 }, // FIXME VK_FORMAT_G4R4_UNORM_PACK8 isn't available
    [PACK_FORMAT(GR_CH_FMT_R4G4B4A4, GR_NUM_FMT_UNORM)] = { VK_FORMAT_UNDEFINED, 0 }, // FIXME VK_FORMAT_A4B4G4R4_UNORM_PACK16 isn't available
    [PACK_FORMAT(GR_CH_FMT_R5G6B5, GR_NUM_FMT_UNORM)] = { VK_FORMAT_R5G6B5_UNORM_PACK16, 2 },
    [PACK_FORMAT(GR_CH_FMT_B5G6R5, GR_NUM_FMT_UNORM)] = { VK_FORMAT_B5G6R5_UNORM_PACK16, 2 },
    [PACK_FORMAT(GR_CH_FMT_B5G6R5, GR_NUM_FMT_SRGB)] = { VK_FORMAT_UNDEFINED, 2 }, // FIXME VK_FORMAT_R5G6B5_SRGB_PACK16 isn't available
    [PACK_FORMAT(GR_CH_FMT_R5G5B5A1, GR_NUM_FMT_UNORM)] = { VK_FORMAT_UNDEFINED, 2 }, // FIXME VK_FORMAT_A1B5G5R5_UNORM_PACK16 isn't available
    [PACK_FORMAT(GR_CH_FMT_R8, GR_NUM_FMT_UNORM)] = { VK_FORMAT_R8_UNORM, 1},
    [PACK_FORMAT(GR_CH_FMT_R8, GR_NUM_FMT_SNORM)] = { VK_FORMAT_R8_SNORM, 1},
    [PACK_FORMAT(GR_CH_FMT_R8, GR_NUM_FMT_UINT)] = { VK_FORMAT_R8_UINT, 1 },
    [PACK_FORMAT(GR_CH_FMT_R8, GR_NUM_FMT_SINT)] = { VK_FORMAT_R8_SINT, 1 },
    [PACK_FORMAT(GR_CH_FMT_R8, GR_NUM_FMT_SRGB)] = { VK_FORMAT_R8_SRGB, 1 },
    [PACK_FORMAT(GR_CH_FMT_R8, GR_NUM_FMT_DS)] = { VK_FORMAT_S8_UINT, 1 },
    [PACK_FORMAT(GR_CH_FMT_R8G8, GR_NUM_FMT_UNORM)] = { VK_FORMAT_R8G8_UNORM, 2 },
    [PACK_FORMAT(GR_CH_FMT_R8G8, GR_NUM_FMT_SNORM)] = { VK_FORMAT_R8G8_SNORM, 2 },
    [PACK_FORMAT(GR_CH_FMT_R8G8, GR_NUM_FMT_UINT)] = { VK_FORMAT_R8G8_UINT, 2 },
    [PACK_FORMAT(GR_CH_FMT_R8G8, GR_NUM_FMT_SINT)] = { VK_FORMAT_R8G8_SINT, 2 },
    [PACK_FORMAT(GR_CH_FMT_R8G8B8A8, GR_NUM_FMT_UNORM)] = { VK_FORMAT_R8G8B8A8_UNORM, 4 },
    [PACK_FORMAT(GR_CH_FMT_R8G8B8A8, GR_NUM_FMT_SNORM)] = { VK_FORMAT_R8G8B8A8_SNORM, 4 },
    [PACK_FORMAT(GR_CH_FMT_R8G8B8A8, GR_NUM_FMT_UINT)] = { VK_FORMAT_R8G8B8A8_UINT, 4},
    [PACK_FORMAT(GR_CH_FMT_R8G8B8A8, GR_NUM_FMT_SINT)] = { VK_FORMAT_R8G8B8A8_SINT, 4 },
    [PACK_FORMAT(GR_CH_FMT_R8G8B8A8, GR_NUM_FMT_SRGB)] = { VK_FORMAT_R8G8B8A8_SRGB, 4 },
    [PACK_FORMAT(GR_CH_FMT_B8G8R8A8, GR_NUM_FMT_UNORM)] = { VK_FORMAT_B8G8R8A8_UNORM, 4 },
    [PACK_FORMAT(GR_CH_FMT_B8G8R8A8, GR_NUM_FMT_SRGB)] = { VK_FORMAT_B8G8R8A8_SRGB, 4 },
    [PACK_FORMAT(GR_CH_FMT_R10G11B11, GR_NUM_FMT_FLOAT)] = { VK_FORMAT_UNDEFINED, 4 }, // FIXME VK_FORMAT_B11G11R10_UFLOAT_PACK32 isn't available
    [PACK_FORMAT(GR_CH_FMT_R11G11B10, GR_NUM_FMT_FLOAT)] = { VK_FORMAT_B10G11R11_UFLOAT_PACK32, 4 },
    [PACK_FORMAT(GR_CH_FMT_R10G10B10A2, GR_NUM_FMT_UNORM)] = { VK_FORMAT_A2B10G10R10_UNORM_PACK32, 4 },
    [PACK_FORMAT(GR_CH_FMT_R10G10B10A2, GR_NUM_FMT_UINT)] = { VK_FORMAT_A2B10G10R10_UINT_PACK32, 4 },
    [PACK_FORMAT(GR_CH_FMT_R16, GR_NUM_FMT_UNORM)] = { VK_FORMAT_R16_UNORM, 2 },
    [PACK_FORMAT(GR_CH_FMT_R16, GR_NUM_FMT_SNORM)] = { VK_FORMAT_R16_SNORM, 2 },
    [PACK_FORMAT(GR_CH_FMT_R16, GR_NUM_FMT_UINT)] = { VK_FORMAT_R16_UINT, 2 },
    [PACK_FORMAT(GR_CH_FMT_R16, GR_NUM_FMT_SINT)] = { VK_FORMAT_R16_SINT, 2 },
    [PACK_FORMAT(GR_CH_FMT_R16, GR_NUM_FMT_FLOAT)] = { VK_FORMAT_R16_SFLOAT, 2 },
    [PACK_FORMAT(GR_CH_FMT_R16, GR_NUM_FMT_DS)] = { VK_FORMAT_D16_UNORM, 2 },
    [PACK_FORMAT(GR_CH_FMT_R16G16, GR_NUM_FMT_UNORM)] = { VK_FORMAT_R16G16_UNORM, 4 },
    [PACK_FORMAT(GR_CH_FMT_R16G16, GR_NUM_FMT_SNORM)] = { VK_FORMAT_R16G16_SNORM, 4 },
    [PACK_FORMAT(GR_CH_FMT_R16G16, GR_NUM_FMT_UINT)] = { VK_FORMAT_R16G16_UINT, 4 },
    [PACK_FORMAT(GR_CH_FMT_R16G16, GR_NUM_FMT_SINT)] = { VK_FORMAT_R16G16_SINT, 4 },
    [PACK_FORMAT(GR_CH_FMT_R16G16, GR_NUM_FMT_FLOAT)] = { VK_FORMAT_R16G16_SFLOAT, 4 },
    [PACK_FORMAT(GR_CH_FMT_R16G16B16A16, GR_NUM_FMT_UNORM)] = { VK_FORMAT_R16G16B16A16_UNORM, 8 },
    [PACK_FORMAT(GR_CH_FMT_R16G16B16A16, GR_NUM_FMT_SNORM)] = { VK_FORMAT_R16G16B16A16_SNORM, 8 },
    [PACK_FORMAT(GR_CH_FMT_R16G16B16A16, GR_NUM_FMT_UINT)] = { VK_FORMAT_R16G16B16A16_UINT, 8 },
    [PACK_FORMAT(GR_CH_FMT_R16G16B16A16, GR_NUM_FMT_SINT)] = { VK_FORMAT_R16G16B16A16_SINT, 8 },
    [PACK_FORMAT(GR_CH_FMT_R16G16B16A16, GR_NUM_FMT_FLOAT)] = { VK_FORMAT_R16G16B16A16_SFLOAT, 8 },
    [PACK_FORMAT(GR_CH_FMT_R32, GR_NUM_FMT_UINT)] = { VK_FORMAT_R32_UINT, 4 },
    [PACK_FORMAT(GR_CH_FMT_R32, GR_NUM_FMT_SINT)] = { VK_FORMAT_R32_SINT, 4 },
    [PACK_FORMAT(GR_CH_FMT_R32, GR_NUM_FMT_FLOAT)] = { VK_FORMAT_R32_SFLOAT, 4 },
    [PACK_FORMAT(GR_CH_FMT_R32, GR_NUM_FMT_DS)] = { VK_FORMAT_D32_SFLOAT, 4 },
    [PACK_FORMAT(GR_CH_FMT_R32G32, GR_NUM_FMT_UINT)] = { VK_FORMAT_R32G32_UINT, 8 },
    [PACK_FORMAT(GR_CH_FMT_R32G32, GR_NUM_FMT_SINT)] = { VK_FORMAT_R32G32_SINT, 8 },
    [PACK_FORMAT(GR_CH_FMT_R32G32, GR_NUM_FMT_FLOAT)] = { VK_FORMAT_R32G32_SFLOAT, 8 },
    [PACK_FORMAT(GR_CH_FMT_R32G32B32, GR_NUM_FMT_UINT)] = { VK_FORMAT_R32G32B32_UINT, 12 },
    [PACK_FORMAT(GR_CH_FMT_R32G32B32, GR_NUM_FMT_SINT)] = { VK_FORMAT_R32G32B32_SINT, 12 },
    [PACK_FORMAT(GR_CH_FMT_R32G32B32, GR_NUM_FMT_FLOAT)] = { VK_FORMAT_R32G32B32_SFLOAT, 12 },
    [PACK_FORMAT(GR_CH_FMT_R32G32B32A32, GR_NUM_FMT_UINT)] = { VK_FORMAT_R32G32B32A32_UINT, 16 },
    [PACK_FORMAT(GR_CH_FMT_R32G32B32A32, GR_NUM_FMT_SINT)] = { VK_FORMAT_R32G32B32A32_SINT, 16 },
    [PACK_FORMAT(GR_CH_FMT_R32G32B32A32, GR_NUM_FMT_FLOAT)] = { VK_FORMAT_R32G32B32A32_SFLOAT, 16 },
    [PACK_FORMAT(GR_CH_FMT_R16G8, GR_NUM_FMT_DS)] = { VK_FORMAT_D16_UNORM_S8_UINT, 0 },
    [PACK_FORMAT(GR_CH_FMT_R32G8, GR_NUM_FMT_DS)] = { VK_FORMAT_D32_SFLOAT_S8_UINT, 0 },
    [PACK_FORMAT(GR_CH_FMT_R9G9B9E5, GR_NUM_FMT_FLOAT)] = { VK_FORMAT_E5B9G9R9_UFLOAT_PACK32, 4 },
    [PACK_FORMAT(GR_CH_FMT_BC1, GR_NUM_FMT_UNORM)] = { VK_FORMAT_BC1_RGBA_UNORM_BLOCK, 1 },
    [PACK_FORMAT(GR_CH_FMT_BC1, GR_NUM_FMT_SRGB)] = { VK_FORMAT_BC1_RGBA_SRGB_BLOCK, 1 },
    [PACK_FORMAT(GR_CH_FMT_BC2, GR_NUM_FMT_UNORM)] = { VK_FORMAT_BC2_UNORM_BLOCK, 1 },
    [PACK_FORMAT(GR_CH_FMT_BC2, GR_NUM_FMT_SRGB)] = { VK_FORMAT_BC2_SRGB_BLOCK, 1 },
    [PACK_FORMAT(GR_CH_FMT_BC3, GR_NUM_FMT_UNORM)] = { VK_FORMAT_BC3_UNORM_BLOCK, 1 },
    [PACK_FORMAT(GR_CH_FMT_BC3, GR_NUM_FMT_SRGB)] = { VK_FORMAT_BC3_SRGB_BLOCK, 1 },
    [PACK_FORMAT(GR_CH_FMT_BC4, GR_NUM_FMT_UNORM)] = { VK_FORMAT_BC4_UNORM_BLOCK, 1 },
    [PACK_FORMAT(GR_CH_FMT_BC4, GR_NUM_FMT_SNORM)] = { VK_FORMAT_BC4_SNORM_BLOCK, 1 },
    [PACK_FORMAT(GR_CH_FMT_BC5, GR_NUM_FMT_UNORM)] = { VK_FORMAT_BC5_UNORM_BLOCK, 1 },
    [PACK_FORMAT(GR_CH_FMT_BC5, GR_NUM_FMT_SNORM)] = { VK_FORMAT_BC5_SNORM_BLOCK, 1 },
    [PACK_FORMAT(GR_CH_FMT_BC6U, GR_NUM_FMT_FLOAT)] = { VK_FORMAT_BC6H_UFLOAT_BLOCK, 1 },
    [PACK_FORMAT(GR_CH_FMT_BC6S, GR_NUM_FMT_FLOAT)] = { VK_FORMAT_BC6H_SFLOAT_BLOCK, 1 },
    [PACK_FORMAT(GR_CH_FMT_BC7, GR_NUM_FMT_UNORM)] = { VK_FORMAT_BC7_UNORM_BLOCK, 1 },
    [PACK_FORMAT(GR_CH_FMT_BC7, GR_NUM_FMT_SRGB)] = { VK_FORMAT_BC7_SRGB_BLOCK, 1 },
};
...
{
    uint32_t packed = PACK_FORMAT(format.channelFormat, format.numericFormat);
    return formats[packed].vkFormat;
}
